...
document.getElementById("study-button").onclick = () => {
  ...
  setTimeout(() => { button.style.background = "linear-gradient(135deg, #ff9800, #ff5722)"; }, 300);
...
document.getElementById("add-todo").onclick = () => {
  ...
  todos[subject].push({ text: todoText, done: false });
